...
def CalculVitesse():
    global omegaArriereDroit, omegaArriereGauche, timeLastReceived, timeout, timedOut, \
        ...
        distanceFiltre, tauFiltreDistance, imu, gz, R, W, vxmes, ximes, vxref, xiref, source_ximes
    ...
    ximes = (omegaArriereDroit - omegaArriereGauche) * R / W
    ...
    if timedOut:
        ...
        commandeRot = PID(1, xiref, ximes, Kprot, Kirot, Kdrot, Tfrot, umax, umin, dt);
        if (source_ximes == 1):
    ...
    commandeArriereDroit = -(commandeLongi + commandeRot) # Tension négative pour faire tourner positivement ce moteur
    commandeArriereGauche = commandeLongi - commandeRot
...
class WSHandler(tornado.websocket.WebSocketHandler):
    ...
    def sendToSocket(self):
        global socketOK, vxmes, ximes, omegaArriereDroit, omegaArriereGauche, gz, vxref, xiref
